...
| options | set children optional | string\[] \| number\[] \| Array&lt;{ label: string value: string disabled?: boolean className?: string style?: CSSProperties }> | - | 4.70.0（className/style） |
| optionType | Set Radio optionType | `default` \| `button` | `default` | 3.0.0 |
| block | Option nodes as block | boolean | false | 4.70.0 |
