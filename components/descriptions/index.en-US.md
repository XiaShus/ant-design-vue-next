...
| contentStyle | Customize content style. Please use `styles.content` instead | CSSProperties | - | 2.2.0 |  |  |
...
| labelStyle | Customize label style. Please use `styles.label` instead | CSSProperties | - | 2.2.0 |  |  |
